    ...
    <div className="autopsy-root">
      ...
      <div className="autopsy-container">
        ...
        {status==="done"&&caseData&&analysis&&<div className="report">
          ...
          <button className="raw-toggle" onClick={()=>setShowRaw(s=>!s)}>Raw evidence{showRaw?<ChevronUp size={14}/>:<ChevronDown size={14}/>}</button>{showRaw&&<div className="raw-body">{JSON.stringify(caseData,null,2)}</div>}
        </div>}
      </div>
    </div>
  );
